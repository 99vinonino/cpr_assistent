# PRACTICE DIRECTION 59 –CIRCUIT COMMERCIAL COURTS
...
### 2.2
The claim form must be marked in the top right hand corner ‘Business and Property Courts in [………] In the High Court of Justice’ and either, Circuit Commercial Court (KBD)’, or ‘Business and Property Courts of England and Wales, London Circuit Commercial Court (KBD)’ as appropriate.
### 2.3
Omitted
### 2.4
Omitted
...
### 3.1
A party who intends to bring a claim in a Circuit Commercial Court must make any application before the claim form is issued to a judge of that court.
### 3.2
The written evidence in support of such an application should show why the claim is suitable to proceed as a Circuit Commercial claim.
## Transfer of proceedings to or from a Circuit Commercial Court
### 4.1
If a claim which has not been issued in a Circuit Commercial Court is suitable to continue as a Circuit Commercial claim –
(1) any party wishing the claim to be transferred to a Circuit Commercial Court may make an application for transfer to the court to which transfer is sought;
(2) if all parties consent to the transfer, the application may be made by letter to the Circuit Commercial listing officer of the court to which transfer is sought, stating why the case is suitable to be transferred to that court and enclosing the written consents of the parties, the claim form and statements of case.
### 4.2
If an application for transfer is made to a court which does not have power to make the order, that court may –
(1) adjourn the application to be heard by a Circuit Commercial judge; or
(2) dismiss the application.
### 4.3
A Circuit Commercial judge may make an order under rule 59.3 of his own initiative.
...
(1) will normally cover all steps in the case through to trial, including the fixing of a trial date or window, or directions for the taking of steps to fix the trial date or window; and
...
(1) provide to the court and each other party an appropriate indexed file for the application with consecutively numbered pages; and
